...
help(){
	...
	echo
	echo "Usage:"
	echo "./fwc-add-port-forwarding.sh -f <Source Port Info> -t <To Port value> -i <To IP> [-h|--help]"
	echo
	echo "Options:"
...
CMD="sudo firewall-cmd --add-forward-port=port=$FROM_PORT:proto=$FROM_PROTO:toport=$TO_PORT"
if [ ! -z "$TO_IP" ];
then
