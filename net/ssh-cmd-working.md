...
2) 삭제 ( --delete-connection | -d )
```
$ ./ssh-cmd -d
================================================================================
#     Group     Name           Host                     Port  User    Credential
--------------------------------------------------------------------------------
0001  default   name           server.ymtech.co.kr      22    user    ****************
0002  default   사내 통합 ERP  erp.ymtech.co.kr         22    ymtech  ****************
0003  com#1     com            gitlab.ymtech.co.kr      22    ymtech  ****************
0004  team-1    tex            192.168.0.123            24    user    ****************
0005  xyz       gitlab         gitlab.ymtch.co.kr       22    ymtech  ****************
0006  xyz       xyz            sts.ymtech.co.kr         22    ymtech  ****************
0007  xyz       xyz-1          sts.ymtech.co.kr         22    ymtech  ****************
0008  ymtech    Repository     nexus3-int.ymtech.co.kr  22    ymtech  ****************
0009  ymtech    gitlab 서버    gitlab.ymtech.co.kr      22    ymtech  ****************
0010  ymtech-x  gitlab-x       gitlab.ymtech.co.kr      22    ymtech  ****************
================================================================================
...
Group    Name  Host                 Port  User  Credential
----------------------------------------------------------
default  name  server.ymtech.co.kr  22    user  ****************
========================================================== <-- 추가할 것
❓  정말 삭제하시겠습니까? (y/N): y
삭제 완료.
$ 
...
2. 개발요구서(SR_v1.8.0 -> SR_v1.8.1)에는 changelog 부분만 작성해 줘.
