...
# @completion: modify-string-in-file.completion
#            1. insert 'source <path>/modify-string-in-file.completion" into ~/bin/.bashrc or ~/bin/.bash_profile for a personal usage.
...
help(){
    ...
    echo
    echo "Usage:"
    echo "modify-string-in-file.sh -d <target-directory> -f <file> -o <old string> -n <new string> [-h|--help]"
    echo
    echo "Options:"
